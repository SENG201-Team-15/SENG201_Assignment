...
public class Food1 extends DinoFood{
	...
	public Food1(){
		...
		name = "Caesar Salad";
		description = "Made by the reincarnated king himself. Caesar's life goal is to rule the kitchen with the most nutritious dinosaur sized salad in the world"; 
		meat = false; 
	}
